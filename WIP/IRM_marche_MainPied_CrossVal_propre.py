...
motor_label=np.fromfile('F:/IRM_Marche/masquesROI/reg_whole50_basc524asym.np','int')
#motor_label=np.fromfile('F:/IRM_Marche/masquesROI/reg_control200_basc444asym.np','int')
...
table.to_excel("C:/Users/mmenoret/Dropbox/Recherche/Articles/IRM_Marche/Papier 2/Accuracy_scores_newbasc.xls")